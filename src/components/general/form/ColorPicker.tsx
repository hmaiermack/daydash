        ...
        {({open}) => (
            ...
            */}
                ...
                <div className='flex flex-col sm:flex-row'>
                    <div className={`flex `}>
                    <Combobox.Input
                        className={`appearance-none blockbg-white text-gray-900 font-medium rounded-lg py-3 px-3 leading-tight`}
                    ...
                    />
                    <Combobox.Button
                    className={`w-10 h-10  ml-2 rounded-full focus:outline-none focus:shadow-outline inline-flex p-2 shadow text-white ${open || !props.value ? 'hidden' : ''}`} style={{background: `${inputString}`}}>
                    ...
                    <Combobox.Options as="div" className="w-full sm:w-44 bg-white flex flex-wrap justify-between mt-4 sm:mt-0 sm:ml-4 p-1 rounded">
